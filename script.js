...
var decisao = null
var l = document.getElementsByName('red')
var pre = Math.floor(Math.random()*2);
var premio= pre+1
var portas = [1,2,3]
a = 0
b=0
...
function clicar0(){
  ...
  porta1.style.boxShadow = "3px 3px 10px black"
  porta2.style.boxShadow = "3px 3px 10px black"
  }else{
...
function clicar1(){
  ...
  var escolha = 2
  a = escolha
  porta0.style.boxShadow = "3px 3px 10px black"
